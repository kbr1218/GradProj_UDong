...
export const Text = {
    ...
    RegulBody: styled.div<StyleText>`
        ...
        cursor: ${props => props.pointer && "pointer"};
    `,
    SmallText: styled.div<StyleText>`
        ...
        cursor: ${props => props.pointer && "pointer"};
    `,
    RegistText: styled.div<StyleText>`
        font-weight: 600;
        font-size: 14px;
        display: inline-block;
        margin: ${props => props.margin};
...
export const Input = {
    FormInput: styled.input<StyleInput>`
        ...
        border: 0px;
        border-bottom: 1px solid ${props => (props.error ? `${theme.colors.red}` : `${theme.colors.gray300}`)};
        margin-bottom: 29px;
    `,
    ...
    `,
    TodoInput: styled.input<StyleInput>`
        width: 22px;
        height: 22px;
        font-size: ${props => props.fontSize};
        color: ${({ color }) => (color ? theme.colors[color] : theme.colors.black)};
        ...
        border-radius: 3px;
        /* border-bottom: 1px solid ${props => (props.error ? `${theme.colors.red}` : "black")}; */
        margin-bottom: 29px;
    `,
    ChatInput: styled.textarea<StyleInput>`
        width: 375px;
        height: 100%;
        font-size: ${props => props.fontSize};
        color: ${({ color }) => (color ? theme.colors[color] : theme.colors.black)};
        ...
        resize: none;
    `,
    InfoRadioBoxInput: styled.input<StyleInput>`
        position: absolute;
        width: 1px;
        height: 1px;
        background: gray;
...
export const Block = {
    ...
    Box: styled.div<StyleBlock>`
        ...
        gap: ${props => props.gap};
    `,
    LoginBox: styled.div<StyleBlock>`
        width: ${props => (props.width ? props.width : "100%")};
        height: ${props => (props.width ? props.height : "auto")};
        cursor: ${props => props.pointer && "pointer"};
        display: flex;
